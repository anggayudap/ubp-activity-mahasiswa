...
@section('title', 'Master Data Klasifikasi Kegiatan')
@section('menu-title', 'Kelola Data Klasifikasi Kegiatan')
                        ...
                        <table class="datatables-ajax table dataTable" id="DataTables_Table_0">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Grup Kegiatan') }}</th>
                                    <th>{{ __('Nama Alternatif') }}</th>
                                    <th>{{ __('Aksi') }}</th>
                                </tr>
                            </thead>
                        </table>
        ...
        var table = $('.datatables-ajax').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, button, config) {
                    window.location = "{{ route('master.klasifikasi.create') }}";
                }
            }],
