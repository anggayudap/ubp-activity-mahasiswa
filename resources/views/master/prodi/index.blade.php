...
@section('menu-title', 'Kelola Data Departemen')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">Departemen data</h4>
                </div>
...
<script type="text/javascript">
    ...
    var table = $('.datatables-ajax').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('master.departement.index') }}",
        columns: [{
                data: 'name',
                name: 'name'
            },
        ...
        buttons: [{
            ...
            action: function (e, dt, button, config) {
                window.location = "{{ route('master.departement.create') }}";
            }
        }],
