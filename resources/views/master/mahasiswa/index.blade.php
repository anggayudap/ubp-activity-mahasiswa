...
@section('menu-title', 'Kelola Data Mahasiswa')
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('.datatables-ajax').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.mahasiswa.index') }}",
            columns: [{
                    data: 'nim',
                    name: 'nim'
                },
            ...
            buttons: [{
                ...
                action: function(e, dt, button, config) {
                    window.location = "{{ route('master.mahasiswa.update_mahasiswa') }}";
                }
            }],
