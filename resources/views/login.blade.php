                ...
                <div class="card-body">
                    ...
                    <form class="auth-login-form mt-2" action="{{ route('login_submit') }}" method="POST">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="john@example.com" value="{{ old('email') }}" tabindex="1" autofocus autocomplete="off" required/>
                            @error('email')
                        ...
                        <div class="mb-1">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="https://sipt2.ubpkarawang.ac.id/forgot-password">
...
@push('styles')
<link rel="stylesheet" type="text/css" href="{{ URL::asset('vuexy/css/pages/authentication.css') }}" >
@endpush

@push('scripts')
<script src="{{ URL::asset('vuexy/js/scripts/pages/auth-login.js')}}"></script>
@endpush
